...
###*
 ...
 # Description - Common Service, Factory, Directive
###
((window, angular) ->
	'use strict'
...
#	common constant
	constant = ()->
		...
		@isiOS = ()->
			...
			return /(iPhone|iPod|iPad)/i.test(a)
		...
		@isIE = ()->
			return /MSIE (\d+\.\d+);/.test(window.navigator.userAgent)
...
#	common directives
	angular.module('sunCommon', ['ng'])
	angular.module('sunCommon').constant('browserData', new constant)
	angular.module('sunCommon').directive 'checkHeight', (setMinHeight)
	return
